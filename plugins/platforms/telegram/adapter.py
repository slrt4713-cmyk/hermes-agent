...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._approval_state: Dict[int, tuple[str, str | None] | str] = {}
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            self._approval_state[approval_id] = (session_key, (metadata or {}).get("approval_request_id"))
    ...
    async def _handle_callback_query(
        ...
        if data.startswith("ea:"):
            ...
            if len(parts) == 3:
                ...
                session_key, request_id = approval_state if isinstance(approval_state, tuple) else (approval_state, None)
