    ...
    "parameters": {
        ...
        "properties": {
            ...
            "memory_provider_tools": {
                "type": "boolean",
                "description": "Opt in to explicit tools from the active external memory provider for this job. Implicit memory context, prefetch, and turn synchronization stay disabled. Use only when the job must deliberately read or write provider-backed memory. Defaults to false."
            },
            "workdir": {
                "type": "string",
